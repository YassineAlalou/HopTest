                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" class="form-control" id="datedenaissance" name="datedenaissance"
                                       value="{{$contact -> date_de_naissance}}">
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="noms" name="nomsociete" placeholder="Nom"
                                       value="{{$contact -> nom_societe}}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea type="text" class="form-control" id="adressesociete" name="adresse"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control" id="tel" name="societetel"
                                       placeholder="Telephone" value="{{$contact -> num}}">
                            </div>
                            <div class="form-group col-md-9">
                                <label for="inputPassword4">Site web</label>
                                <input type="text" class="form-control" id="siteweb" name="siteweb"
                                       placeholder="Site Web" value="{{$contact -> site_web}}">
                            </div>
